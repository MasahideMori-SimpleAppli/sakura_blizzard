...
///      bursting in a specified direction, then smoothly transitioning
///      to a gentle hirahira (flutter) falling motion via linear
///      interpolation.
///
/// (ja) 指定した方向に飛び散った後、線形補間によってなめらかに
///      ひらひら落下へ移行する物理演算クラスです。
///
/// Author Masahide Mori
///
class DirectionalConfettiHirahiraPhysics extends Sp3dPhysics {
  /// 爆発フェーズの速度（内部状態）
  double _vx;
  double _vy;
  ...
  ///   2*pi means full random direction.
  ...
  ///   If not specified, a random value will be set.
  /// * [fps] : The screen fps.
  DirectionalConfettiHirahiraPhysics(
    this.size, {
